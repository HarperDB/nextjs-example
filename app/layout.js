	...
	return (
		<html lang="en">
			<body style={{ margin: 0, fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: 1.6, color: '#333', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
					...
					<nav style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
						...
						>
							<li style={{ marginRight: 'auto' }}>
								<Link href="/" style={{ color: 'white', textDecoration: 'none', fontSize: '1.25rem', fontWeight: '600' }}>
									Doggy Management System
								</Link>
							</li>
							<li>
								<Link href="/" style={{ color: 'white', textDecoration: 'none', padding: '0.5rem 1rem', borderRadius: '4px', transition: 'background-color 0.2s' }}>
									Home
								</Link>
							</li>
							<li>
								<Link href="/dogs" style={{ color: 'white', textDecoration: 'none', padding: '0.5rem 1rem', borderRadius: '4px', transition: 'background-color 0.2s' }}>
									Dogs
								</Link>
							</li>
						</ul>
				...
				<main style={{ flex: 1, maxWidth: '1200px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column' }}>
					{children}
				</main>
